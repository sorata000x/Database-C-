...
/*20*/     "select * from student where ((major=CS or major =Phsics) and (age < 22 or age > 30)) and (company=Verizon or company = Amazon)"
...
bool sql_basic(bool debug = false)
{
     ...
     sql.command(command_list[0]); //TODO: input command
